...
{
    [Table("FAC_FacturasDet")]
    public partial class FacFacturasDet
    {
        [Key]
        ...
        [InverseProperty(nameof(FacProductos.FacFacturasDet))]
        public virtual FacProductos CodigoProductoNavigation { get; set; }
        [ForeignKey(nameof(NumeroFactura))]
        [InverseProperty(nameof(FacFacturas.FacFacturasDet))]
        public virtual FacFacturas NumeroFacturaNavigation { get; set; }
    }
}
