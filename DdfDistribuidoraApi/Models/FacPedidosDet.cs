...
{
    [Table("FAC_PedidosDet")]
    public partial class FacPedidosDet
    {
        [Key]
        ...
        [ForeignKey("Periodo,Mes,Dia,NumeroPedido")]
        [InverseProperty("FacPedidosDet")]
        public virtual FacPedidos FacPedidos { get; set; }
    }
}
