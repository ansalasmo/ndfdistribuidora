...
{
    [Table("FAC_Pedidos")]
    public partial class FacPedidos
    {
        public FacPedidos()
        {
            FacPedidosDet = new HashSet<FacPedidosDet>();
        }
        ...
        [Column("UbicacioURL")]
        [StringLength(200)]
        public string UbicacioUrl { get; set; }

        [InverseProperty("FacPedidos")]
        public virtual ICollection<FacPedidosDet> FacPedidosDet { get; set; }
    }
}
